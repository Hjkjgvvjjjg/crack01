...
print 'AUTHOR : FAHIM ISLAM 

print 'FACEBOOK : Fahim Ialam'

print 'GITHUB : Hjkjgvvjjjg'

CorrectUsername = 'Tamanna'
...
os.system('xdg-open https://www.facebook.com/Hunter-bd-111615311566288/')
...
def action():
    ...
    print '[\xe2\Fahim] Process Has Been Completed....'

    print '[\xe2\Fahim] Total OK/CP : ' + str(len(oks)) + '/' + str(len(cpb))

    print '[\xe2\Fahim] CP File Has Been Saved : save/checkpoint.txt'
